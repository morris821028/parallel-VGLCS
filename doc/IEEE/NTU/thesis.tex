...
\newcommand*{\PartialPath}{../partial/ntu}
...
%----------- watermark -----------
\CenterWallPaper{0.174}{./scan/watermark.pdf}
...
\includepdf[pages={1}]{./scan/cert.pdf}

\onehalfspacing
\input{\PartialPath/acknowledgements-ch-ntu.tex}

\input{\PartialPath/abstract-ch-ntu.tex}
\doublespacing
\input{\PartialPath/abstract-en-ntu.tex}
\tableofcontents
...
\input{\PartialPath/introduction-en-ntu.tex}

\input{\PartialPath/parallel-VGLCS-en-ntu.tex}

\input{\PartialPath/parallel-RMQ-en-ntu.tex}

\input{\PartialPath/parallel-IRMQ-en-ntu.tex}

\input{\PartialPath/implementation-en-ntu.tex}

\input{\PartialPath/experiment-en-ntu.tex}

\input{\PartialPath/related-en-ntu.tex}

\input{\PartialPath/conclusion-en-ntu.tex}

\input{\PartialPath/future-en-ntu.tex}
