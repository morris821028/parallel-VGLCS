...
\draw[decorate,decoration={brace,amplitude=3mm}](start.45)--node[anchor=south west,above right=5pt and 5pt] {$n-i$ nodes}(end.60);
...
%\node[below left=10pt and 30pt of D]{$t_{{\it root}_i}$};
\node[above right=10pt and 10pt of Anode]{$t_A$};
\end{tikzpicture}
