...
\draw[dsgroup] 
  ...
  ([xshift=-2pt, yshift=2pt]mat1-2-5.south east) {};

\draw[thin]
  (mat1-2-5.south) edge[in=-50, out=-130, loop] (mat1-2-5.south);

\draw[->,thin]
  (mat1-2-6.south) to [bend right=45] (mat1-2-7.south);
\draw[thin]
  (mat1-2-7.south) edge[in=-50, out=-130, loop] (mat1-2-7.south);

\draw[dsgroup] 
  ([xshift=2pt, yshift=-2pt]mat1-2-6.north west) rectangle 
  ([xshift=-2pt, yshift=2pt]mat1-2-7.south east) {};
