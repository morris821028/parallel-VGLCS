...
\draw[decorate,decoration={brace, mirror, amplitude=10pt, raise=5pt}]
  (mat1-2-2.north west) to node[black,midway,above left=-0.5em and 1.4em] {$n$} (mat1-5-2.south west);
\draw[decorate,decoration={brace, amplitude=10pt, raise=5pt}]
  (mat1-2-2.north west) to node[black,midway,above left=1.5em and -1.0em] {$m$} (mat1-2-7.north east);

\begin{scope}
\coordinate(bup) at([yshift=5pt]mat1-5-5.center);
\coordinate(bleft) at([xshift=-5pt]mat1-2-2.center);
\coordinate(bup-f) at([yshift=-15pt]mat1-5-5.center);
\coordinate(bleft-f) at([xshift=-15pt]mat1-2-2.center);
...
\coordinate(bleft) at([xshift=-5pt]mat1-3-2.center);
\coordinate(bup-f) at([yshift=-15pt]mat1-5-4.center);
\coordinate(bleft-f) at([xshift=-15pt]mat1-3-2.center);
...
\coordinate(bleft) at([xshift=-5pt,yshift=5pt]mat1-2-3.center);
\coordinate(bup-f) at([yshift=-15pt]mat1-5-6.center);
\coordinate(bleft-f) at([xshift=-5pt,yshift=15pt]mat1-2-3.center);
...
\coordinate(bleft) at([xshift=-5pt,yshift=5pt]mat1-2-4.center);
\coordinate(bup-f) at([yshift=-15pt]mat1-5-7.center);
\coordinate(bleft-f) at([xshift=-5pt,yshift=15pt]mat1-2-4.center);
...
\coordinate(bleft) at([xshift=-5pt,yshift=5pt]mat1-2-5.center);
\coordinate(bup-f) at([yshift=5pt,xshift=15pt]mat1-4-7.center);
\coordinate(bleft-f) at([xshift=-5pt,yshift=15pt]mat1-2-5.center);

\draw (bup) -- (bleft);
\draw[-{Stealth[scale=1.5]}] (bup) -- (bup-f);
\draw (bleft) -- (bleft-f);
\node[right=1.2em of bup]{$p_1$};
\end{scope}

\begin{scope}
\coordinate(bup) at([yshift=5pt]mat1-3-7.center);
\coordinate(bleft) at([xshift=-5pt,yshift=5pt]mat1-2-6.center);
\coordinate(bup-f) at([yshift=5pt,xshift=15pt]mat1-3-7.center);
\coordinate(bleft-f) at([xshift=-5pt,yshift=15pt]mat1-2-6.center);
...
\coordinate(bleft-f) at([xshift=-15pt]mat1-4-2.center);
...
\draw[decorate,decoration={brace, mirror, amplitude=10pt, raise=5pt}]
  (mat1-2-2.north west) to node[black,midway,above left=-0.5em and 1.4em] {$n+m-1$} (mat1-10-2.south west);
