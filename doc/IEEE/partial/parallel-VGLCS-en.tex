...
\input{\AlgoPath/alg-serial-VGLCS}
...
\begin{figure}[!thb]
  \centering
  \includegraphics[width=\linewidth]{\GraphicPath/fig-VGLCS-dp.pdf}
...
\begin{figure}[!thb]
  \centering \subfigure[Array]{
    \includegraphics[width=\linewidth]{\GraphicPath/fig-interval-decomposition-origin.pdf}
    \label{fig:fig-interval-decomposition}
  } \subfigure[Sparse Table]{
    \includegraphics[width=\linewidth]{\GraphicPath/fig-sparse-table-origin.pdf}
...
\input{\AlgoPath/alg-parallel-sparse-table}
...
\input{\AlgoPath/alg-parallel-VGLCS}
