...
suffix maximium queries, and finds the VGLCS with answers from ISMQ.
...
In the parallel environment, the unstable operation
make load imbalance to run efficiently.  In this paper, we propose a
parallel VGLCS algorithm that is space-efficient and cache-friendly.
...
We consider several data structures other than disjoint sets to
support ISMQ efficiently in parallel.
