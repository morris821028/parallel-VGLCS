...
%% Then, the concept of the sweep line algorithm is the main point to
%% solve each area maximum queries.  We transform the sequential area
%% maximum queries into the incremental suffix maximum queries when
%% moving sweep line.
