...
%% When union two disjoint-set trees, we make the lower index of the root
%% node point to higher index of the root node. Another compression
%% technique is known as {\sc Splicing} ({\sc Sp}) which makes the index
%% of new parent of each node is higher than the index of old parent
%% after {\sc Union} operations.
