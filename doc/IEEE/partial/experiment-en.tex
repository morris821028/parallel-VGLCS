...
%% Although the amortized complexity of answering a query with a disjoint
%% set is $O(\alpha(n))$ or $O(1)$, it causes inefficient
%% synchronizations in a parallel environment,
