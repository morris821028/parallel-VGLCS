...
; 
\node[below=1.0cm, align=flush center,text width=1cm]{$0$};
\end{tikzpicture}
\begin{tikzpicture}[-,>=stealth',level/.style={sibling distance = 1cm/#1,
  level distance = 0.5cm}] 
\node[arn_n]{2}
...
; 
\node[below=1.0cm, align=flush center,text width=1cm]{$1$};
\end{tikzpicture}
\begin{tikzpicture}[-,>=stealth',level/.style={sibling distance = 1cm/#1,
  level distance = 0.5cm}] 
\node[arn_n]{1}
...
; 
\node[below=1.0cm, align=flush center,text width=1cm]{$2$};
\end{tikzpicture}
\begin{tikzpicture}[-,>=stealth',level/.style={sibling distance = 1cm/#1,
  level distance = 0.5cm}] 
\node[arn_n]{0}
...
; 
\node[below=1.0cm, align=flush center,text width=1cm]{$4$};
\end{tikzpicture}